...
694 functions, 121 classes, 16% async, 96% type-hinted.

**Languages:** python (45 files)
...
- `saar/cli.py` <-> `saar/cli.py`


> [23 lines omitted -- run `saar extract --verbose` for full output]
